...
const HistorySidebar: Component<HistorySidebarProps> = (props) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div class={`fixed top-16 right-0 h-[calc(100vh-4rem)] w-96 bg-white dark:bg-neutral-800 shadow-xl z-50 transform transition-transform duration-300 ease-in-out
