-- Migration 013: Fix UUID casting error in admin functions
-- This migration fixes the type casting issue where UUID values were being cast to TEXT
-- when inserting into the target_id column of admin_audit_log
...
-- Also fix the safe_update_user_status function
...
COMMENT ON FUNCTION safe_update_user_role IS 
'Safely updates user role with audit logging. Fixed UUID casting error in target_id column.';