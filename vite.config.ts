    ...
    transformIndexHtml(html: string, context: any) {
      if (context.bundle) {
        ...
        if (cssFiles.length > 0) {
          ...
          const securityMeta = `
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://www.google.com https://www.gstatic.com https://www.recaptcha.net https://static.cloudflareinsights.com https://www.clarity.ms https://scripts.clarity.ms; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://challenges.cloudflare.com https://www.google.com https://ipapi.co https://static.cloudflareinsights.com https://www.clarity.ms https://*.supabase.co wss://*.supabase.co https://chatwiisolidjsapp.pages.dev https://upload.imagekit.io https://ik.imagekit.io; frame-src 'self' https://challenges.cloudflare.com https://www.google.com https://www.recaptcha.net; img-src 'self' data: blob: https://*.supabase.co https://ik.imagekit.io https:;">
