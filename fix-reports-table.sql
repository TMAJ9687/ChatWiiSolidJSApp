...
-- Run this in your Supabase SQL editor to ensure reports table exists with correct schema
...
-- If table doesn't exist or has wrong schema, run this:
-- (Comment out the SELECT above and uncomment below if needed)

/*
-- Drop existing table if it has wrong schema (WARNING: This deletes data!)
